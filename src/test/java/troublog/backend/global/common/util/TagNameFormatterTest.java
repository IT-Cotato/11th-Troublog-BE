...
class TagNameFormatterTest {
	...
	private static Stream<Arguments> provideDisplayToNormalizedNames() {
		return Stream.of(Arguments.of(List.of("Spring Boot", "Java Script", "React"),
				List.of("spring-boot", "java-script", "react")),
	...
	private static Stream<Arguments> provideCamelCaseNames() {
		return Stream.of(Arguments.of("spring-boot", "SpringBoot"), Arguments.of("java-script", "JavaScript"),
			Arguments.of("react", "React"), Arguments.of("node-js", "NodeJs"),
			Arguments.of("type-script", "TypeScript"), Arguments.of("java", "Java"));
	}
}
