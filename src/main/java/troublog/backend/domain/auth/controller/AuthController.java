...
public class AuthController {
	...
	public ResponseEntity<BaseResponse<PasswordEmailUUIDResDto>> findPassword(
		@Valid @RequestBody PasswordEmailCheckReqDto passwordEmailCheckReqDto, HttpServletRequest request) {

		PasswordEmailUUIDResDto passwordEmailUUIDResDto = authFacade.checkEmailForPassword(passwordEmailCheckReqDto, request);
		return ResponseUtils.ok(passwordEmailUUIDResDto);
	}
	...
	public ResponseEntity<BaseResponse<Void>> checkAuthCode(
		@Valid @RequestBody PasswordAuthCodeCheckReqDto passwordAuthCodeCheckReqDto, HttpServletRequest request) {

		authFacade.checkAuthCodePassword(passwordAuthCodeCheckReqDto, request);
		return ResponseUtils.noContent();
	}
	...
	public ResponseEntity<BaseResponse<Void>> changePassword(
		@Valid @RequestBody PasswordChangeReqDto passwordChangeReqDto, HttpServletRequest request) {

		authFacade.changePassword(passwordChangeReqDto, request);
		return ResponseUtils.noContent();
	}
}
