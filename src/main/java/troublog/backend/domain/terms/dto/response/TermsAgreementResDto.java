...
public record TermsAgreementResDto(@Schema(description = "사용자가 동의한 약관 목록. 회원가입 시 저장된 동의 내역 또는 사용자의 약관 동의 이력입니다. "
	+ "각 항목에는 동의 일시, 약관 타입, 동의 여부 등의 정보가 포함됩니다.") List<UserConsentDto> userConsentDtos) {
}