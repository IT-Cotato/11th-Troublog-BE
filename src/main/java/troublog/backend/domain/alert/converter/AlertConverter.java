...
public class AlertConverter {
	...
	public static Alert postTroubleshootingAlert(User user, int count, String targetUrl) {
	...
	public static Alert postLikesAlert(User targetUser, String userLikesName, String targetUrl) {
		return Alert.builder()
			.title("포스트 좋아요 알림")
	...
	public static Alert postCommentAlert(User targetUser, String userCommentName, String targetUrl) {
		return Alert.builder()
			.title("포스트 댓글 알림")
	...
	public static Alert postChildCommentAlert(User targetUser, String userChildCommentName, String targetUrl) {
		return Alert.builder()
			.title("포스트 대댓글 알림")
